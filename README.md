...
Voici notre projet d’automate :

Il contient :

- le fichier **fonction.py**, dans lequel se trouvent les fonctions.
- le fichier **main.py**, qui appelle les fonctions via un menu interactif.
